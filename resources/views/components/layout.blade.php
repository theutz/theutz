            ...
            <ul class="flex justify-center mt-4 space-x-10 text-base font-medium leading-7 text-slate-700 sm:space-x-8 lg:block lg:space-x-0 lg:space-y-4">
                <li class="flex">
                    ...
                    <a href="/" class="flex items-center group">
                        <svg aria-hidden="true" class="w-8 h-8 fill-slate-400 group-hover:fill-slate-600">
                ...
                <li class="flex">
                    ...
                    <a href="/" class="flex items-center group">
                        <svg aria-hidden="true" class="w-8 h-8 fill-slate-400 group-hover:fill-slate-600">
                            ...
                            <path d="M10 25a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z" class="fill-white" />
                            <path d="M7 16a9 9 0 0 1 9 9h3A12 12 0 0 0 7 13v3Z" class="fill-white" />
                            <path d="M7 10a15 15 0 0 1 15 15h3A18 18 0 0 0 7 7v3Z" class="fill-white" />
                        </svg>
