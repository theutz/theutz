<div class="lg:w-112 xl:w-120 bg-slate-50 lg:fixed lg:inset-y-0 lg:left-0 lg:flex lg:items-start lg:overflow-y-auto">
    <div
        ...
        <span class="flex mt-6 font-bold text-slate-900">
            ...
            <span class="mt-6">Wes Mantooth</span>
        </span>
    </div>
    <div
         class="relative z-10 px-4 pt-10 pb-4 mx-auto sm:px-6 md:max-w-2xl md:px-4 lg:min-h-full lg:flex-auto lg:border-x lg:border-slate-200 lg:py-12 lg:px-8 xl:px-12">
        <a href="/"
           class="relative block w-48 mx-auto overflow-hidden rounded-lg shadow-xl bg-slate-200 shadow-slate-200 sm:w-64 sm:rounded-xl lg:w-auto lg:rounded-2xl"
           aria-label="Homepage">
        ...
        <section class="mt-10 lg:mt-12">
            ...
            <ul
                class="flex justify-center mt-4 space-x-10 text-base font-medium leading-7 text-slate-700 sm:space-x-8 lg:block lg:space-x-0 lg:space-y-4">
                <li class="flex">

                    <a href="/"
                       class="flex items-center group">
                        <svg aria-hidden="true"
                             class="w-8 h-8 fill-slate-400 group-hover:fill-slate-600">
                            <path
                        ...
                        <span class="sr-only sm:hidden">Spotify</span>
                    ...
                    <a href="/"
                       class="flex items-center group">
                        <svg aria-hidden="true"
                            ...
                            <path d="M18.056 18.488a1.069 1.069 0 0 0-.32-.688c-.36-.376-.992-.624-1.736-.624-.743 0-1.376.24-1.736.624-.183.2-.287.4-.32.688-.064.56-.024 1.04.04 1.816.065.736.184 1.72.336 2.712.112.712.2 1.096.28 1.368.136.448.625.832 1.4.832.776 0 1.273-.392 1.4-.832.08-.272.169-.656.28-1.368.152-1 .273-1.976.337-2.712.072-.776.104-1.256.04-1.816ZM17.968 14.408c0 1.088-.88 1.967-1.968 1.967a1.967 1.967 0 0 1-1.968-1.967c0-1.088.88-1.968 1.968-1.968s1.968.888 1.968 1.968Z"
                                  class="fill-white" />
                            <path d="M15.976 6.656c-4.592.016-8.352 3.744-8.416 8.336-.048 3.72 2.328 6.904 5.648 8.072.08.032.16-.04.152-.12-.04-.288-.088-.576-.12-.864a.317.317 0 0 0-.168-.232 7.365 7.365 0 0 1-4.424-6.824c.04-4 3.304-7.256 7.296-7.288 4.088-.032 7.424 3.28 7.424 7.36 0 3.016-1.824 5.608-4.424 6.752a.272.272 0 0 0-.168.232l-.12.864c-.016.088.072.152.152.12a8.448 8.448 0 0 0 5.648-7.968c-.016-4.656-3.816-8.448-8.48-8.44Z"
                                  class="fill-white" />
                            <path d="M15.784 9.456c-2.992.112-5.392 2.584-5.432 5.576a5.65 5.65 0 0 0 2.472 4.744c.072.048.176-.008.176-.096a7.853 7.853 0 0 1-.008-.968.326.326 0 0 0-.112-.272 4.574 4.574 0 0 1-1.448-3.456 4.585 4.585 0 0 1 4.392-4.448 4.574 4.574 0 0 1 4.752 4.568c0 1.312-.56 2.496-1.448 3.336a.381.381 0 0 0-.112.272c.016.312.008.616-.008.96-.008.088.096.152.176.096a5.661 5.661 0 0 0 2.472-4.672c.008-3.184-2.656-5.768-5.872-5.64Z"
                                  class="fill-white" />
                        </svg>
                        <span class="sr-only sm:hidden">Apple Podcast</span>
                ...
                <li class="flex">
                    ...
                    <a href="/"
                       class="flex items-center group">
                        ...
                        <span class="sr-only sm:hidden">Overcast</span>
                    ...
                    <a href="/"
                       class="flex items-center group">
                        <svg aria-hidden="true"
                             class="w-8 h-8 fill-slate-400 group-hover:fill-slate-600">
                            <path
                                  d="M23.5 4h-15A4.5 4.5 0 0 0 4 8.5v15A4.5 4.5 0 0 0 8.5 28h15a4.5 4.5 0 0 0 4.5-4.5v-15A4.5 4.5 0 0 0 23.5 4Z" />
                            <path d="M10 25a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z"
                                  class="fill-white" />
                            <path d="M7 16a9 9 0 0 1 9 9h3A12 12 0 0 0 7 13v3Z"
                                  class="fill-white" />
                            <path d="M7 10a15 15 0 0 1 15 15h3A18 18 0 0 0 7 7v3Z"
                                  class="fill-white" />
                        </svg>
                        <span class="sr-only sm:hidden">RSS Feed</span>
...
<div class="py-10 pb-40 border-t border-slate-200 bg-slate-50 sm:py-16 sm:pb-32 lg:hidden">
    <div class="px-4 mx-auto sm:px-6 md:max-w-2xl md:px-4">
        ...
        <h2 class="flex items-center mt-8 font-mono text-sm font-medium leading-7 text-slate-900">
            <svg aria-hidden="true"
                 viewBox="0 0 11 12"
                 class="w-auto h-3 fill-slate-300">
                <path
        ...
        <div class="flex mt-2 text-sm font-bold leading-7 text-slate-900">
            ...
            <span class="ml-6">Bob Saget</span>
        </div>
    </div>
</div>
