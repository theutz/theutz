...
<body>
    <div
        ...
        <div
             className="relative z-10 px-4 pt-10 pb-4 mx-auto sm:px-6 md:max-w-2xl md:px-4 lg:min-h-full lg:flex-auto lg:border-x lg:border-slate-200 lg:py-12 lg:px-8 xl:px-12">
            <Link href="/">
            <a className="relative block w-48 mx-auto overflow-hidden rounded-lg shadow-xl bg-slate-200 shadow-slate-200 sm:w-64 sm:rounded-xl lg:w-auto lg:rounded-2xl"
               aria-label="Homepage">
            ...
            <section className="mt-10 lg:mt-12">
                <h2
                    className="flex items-center font-mono text-sm font-medium leading-7 sr-only text-slate-900 lg:not-sr-only">
                ...
                <ul
                    className="flex justify-center mt-4 space-x-10 text-base font-medium leading-7 text-slate-700 sm:space-x-8 lg:block lg:space-x-0 lg:space-y-4">
                    <li className="flex">
                        <Link href="/">
    ...
    <div className="fixed inset-x-0 bottom-0 right-0 z-10 rounded-lg lg:left-112 xl:left-120">
        <AudioPlayer />
    </div>
</body>
